 ...
 *
 * Use this strategy to resolve objects of type `PageNode` from `figma` API.
 *
 ...
 * @see Strategy
 */
export default class StrategyFigmaPageNode extends StrategyFigmaNode {
  constructor(handler: IStrategyCallback) {
    super(handler, 'PageNode')
  }
}
