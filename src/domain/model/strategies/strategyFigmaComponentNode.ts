 ...
 *
 * Use this strategy to resolve objects of type `ComponentNode` from `figma` API.
 *
 ...
 * @see Strategy
 */
export default class StrategyFigmaComponentNode extends StrategyFigmaNode {
  constructor(handler: IStrategyCallback) {
    super(handler, 'ComponentNode')
  }
}
