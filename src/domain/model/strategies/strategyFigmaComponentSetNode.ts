 ...
 *
 * Use this strategy to resolve objects of type `ComponentSetNode` from `figma` API.
 *
 ...
 * @see Strategy
 */
export default class StrategyFigmaComponentSetNode extends StrategyFigmaNode {
  constructor(handler: IStrategyCallback) {
    super(handler, 'ComponentSetNode')
  }
}
