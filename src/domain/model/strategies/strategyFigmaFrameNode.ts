 ...
 *
 * Use this strategy to resolve objects of type `FrameNode` from `figma` API.
 *
 ...
 * @see Strategy
 */
export default class StrategyFigmaFrameNode extends StrategyFigmaNode {
  constructor(handler: IStrategyCallback) {
    super(handler, 'FrameNode')
  }
}
