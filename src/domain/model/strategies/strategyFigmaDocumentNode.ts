 ...
 *
 * Use this strategy to resolve objects of type `DocumentNode` from `figma` API.
 *
 ...
 * @see Strategy
 */
export default class StrategyFigmaDocumentNode extends StrategyFigmaNode {
  constructor(handler: IStrategyCallback) {
    super(handler, 'DocumentNode')
  }
}
